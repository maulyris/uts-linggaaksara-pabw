        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    <?php 
                        $query = "SELECT *, SUM(jumlah) as jml from pohon";
                    ...
                    <br>
                    <?php
                        $strQuery = "SELECT *, SUM(jumlah) AS jmlh FROM pohon GROUP BY(jenis) ORDER BY jenis ASC";
                        ...
                        if ($result) {
                            $arrData = array(
                                "chart" => array(
                                    "caption" => "Jumlah Pohon Berdasarkan Jenis",
                                    "showValues" => "0",
                                    "theme" => "fusion"
                                )
                            );
