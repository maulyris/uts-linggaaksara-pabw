...
{	
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE pohon SET nama='$nama', jenis='$jenis', harga='$harga', jumlah='$jumlah' WHERE id=$id");
...
$result = mysqli_query($conn, "SELECT * FROM pohon WHERE id='" . $_GET['id'] . "'");
                ...
                <div class="col-md-12">
                    ...
                    <form name="update" method="post" action="edit.php">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="jenis" class="form-control"><?php echo $row['jenis']; ?></textarea>
                        </div>
                        <div class="form-group">
